...
public class ModelField extends ModelChild {
    ...
    public ModelField(Element fieldElement) {
        ...
        this.isUpdatable = UtilXml.checkBoolean(fieldElement.getAttribute("updatable"), true);
    ...
    public void mergeOverrideModelField(ModelField newModelField) {
        if (UtilValidate.isNotEmpty(newModelField.type))
            this.type = newModelField.type;
        if (UtilValidate.isNotEmpty(newModelField.getColName()))
            this.setColName(newModelField.getColName());
        if (UtilValidate.isNotEmpty(newModelField.getColName()))
            this.description = newModelField.description;
    }
