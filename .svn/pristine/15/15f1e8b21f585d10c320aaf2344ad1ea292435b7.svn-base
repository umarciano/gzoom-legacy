...
public class SQLProcessor {
     ...
     */
    public void setObject(SqlObjectHandler handler, Object field) throws SQLException, ConversionException, ClassNotFoundException {
        handler.setObject(_ps, _ind, field);
        _ind++;
    }
