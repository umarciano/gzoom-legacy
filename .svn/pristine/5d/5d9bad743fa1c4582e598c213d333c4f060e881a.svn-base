<tr>
   ...
   <input type="text" size="100" maxlength="255" value="" class="droplist_edit_field"  name="valuedId_edit_value" id="${printBirtFormId?default("ManagementPrintBirtForm")}_valuedId_edit_value"  />   
   <input type="hidden" class="droplist_code_field" name="valuedId"/>
