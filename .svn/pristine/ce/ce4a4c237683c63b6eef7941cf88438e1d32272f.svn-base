...
public class FormFactory {
    ...
    public static ModelForm getFormFromLocation(String resourceName, String formName, ModelReader entityModelReader, DispatchContext dispatchContext)
        ...
        if (Debug.timingOn()) {
            Debug.logTiming("getFormFromLocation " + cacheKey + " = " + modelForm, module);
        }
        if (modelForm == null) {
                ...
                if (modelForm == null) {
                    ...
                    */
					...
					if (Debug.timingOn()) {
                        ...
                        Debug.logTiming("Got " + modelForm.getName() + " in " + totalSeconds + " milliseconds from: " + resourceName, module);
                    }
                }
            }
        }
		...
		if (Debug.timingOn()) {
            double totalSeconds = (System.currentTimeMillis() - startTime);
            Debug.logTiming("Got " + modelForm.getName() + " in " + totalSeconds + " milliseconds", module);
        }
        return modelForm;
    }
    ...
    public static ModelForm getFormFromWebappContext(String resourceName, String formName, HttpServletRequest request)
        ...
        long startTime = System.currentTimeMillis();
        if (Debug.timingOn()) {
            Debug.logTiming("getFormFromWebappContext " + cacheKey + " = " + modelForm, module);
        }
        if (modelForm == null) {
            synchronized (formWebappCache) {
                ...
                if (modelForm == null) {
                    ...
                    if (Debug.timingOn()) {
                        double totalSeconds = (System.currentTimeMillis() - startTime);
                        Debug.logTiming("Got " + modelForm.getName() + " in " + totalSeconds + " milliseconds from " + formFileUrl, module);
                    }
                }
            }
        }
