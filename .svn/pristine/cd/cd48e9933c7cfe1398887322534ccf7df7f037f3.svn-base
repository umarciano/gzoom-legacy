...
/**
 * I filtri applicati i nquesta ricerca vanno applicati anche nel groovy executePerformFindDIWorkEffortRootInqy.groovy
 * perche altrimenti il cambio stato fa una query diversa...
 */
context.permission = "DIRIGPERF"; 
parameters.weContextId = "CTX_DI";
