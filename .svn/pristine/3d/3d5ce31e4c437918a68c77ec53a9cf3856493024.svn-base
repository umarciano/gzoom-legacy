...
public interface DataResourceWorkerInterface {
    ...
    public Map<String, Object> getDataResourceAsStream(GenericValue dataResource, String https, String webSiteId, Locale locale, String contextRoot, boolean cache) throws GeneralException, IOException;
