DROP
	VIEW IF EXISTS PARTY_TEMPLATE_VIEW CASCADE;
 ...
 CREATE
	VIEW PARTY_TEMPLATE_VIEW AS SELECT
		PH.PARTY_ID,
		CASE
			WHEN PH.FROM_DATE IS NULL THEN TO_DATE(
				'20000101',
				'YYYYMMDD'
			)
			ELSE PH.FROM_DATE
...
UNION SELECT
		PER.PARTY_ID,
		CASE
			WHEN PER.EMPL_POSITION_TYPE_DATE IS NULL THEN TO_DATE(
				'20000101',
				'YYYYMMDD'
			)
...
DROP
	VIEW IF EXISTS ORG_ALLOCATION_VIEW CASCADE;

DROP
	VIEW IF EXISTS FROM_DATE_ALLOCATION_VIEW CASCADE;

DROP
	VIEW IF EXISTS THRU_DATE_ALLOCATION_VIEW CASCADE;

DROP
	VIEW IF EXISTS FROM_DATE_ALLOCATION_VIEW_TOT CASCADE;

DROP
	VIEW IF EXISTS THRU_DATE_ALLOCATION_VIEW_TOT CASCADE;

DROP
	VIEW IF EXISTS FROM_THRU_DATE_ALLOCATION_VIEW CASCADE;

DROP
	VIEW IF EXISTS ALLOCATION_TEMPLATE_VIEW CASCADE;
 ...
 CREATE
	VIEW ORG_ALLOCATION_VIEW AS SELECT
		...
		PREL.FROM_DATE,
		CASE
			WHEN PREL.THRU_DATE IS NULL THEN TO_DATE(
				'20991231',
				'YYYYMMDD'
			)
			ELSE PREL.THRU_DATE
...
DROP
	VIEW IF EXISTS ORG_EMPLOYMENT_VIEW CASCADE;

DROP
	VIEW IF EXISTS FROM_DATE_EMPLOYMENT_VIEW CASCADE;

DROP
	VIEW IF EXISTS THRU_DATE_EMPLOYMENT_VIEW CASCADE;

DROP
	VIEW IF EXISTS FROM_DATE_EMPLOYMENT_VIEW_TOT CASCADE;

DROP
	VIEW IF EXISTS THRU_DATE_EMPLOYMENT_VIEW_TOT CASCADE;

DROP
	VIEW IF EXISTS FROM_THRU_DATE_EMPLOYMENT_VIEW CASCADE;

DROP
	VIEW IF EXISTS EMPLOYMENT_TEMPLATE_VIEW CASCADE;
