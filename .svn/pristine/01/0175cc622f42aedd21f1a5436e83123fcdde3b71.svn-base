...
public class CallSimpleMethod extends MethodOperation {
    ...
    public boolean exec(MethodContext methodContext) {
    	if (UtilValidate.isNotEmpty(this.methodName)) {
            ...
            try {
                simpleMethodToCall = getSimpleMethodToCall(methodName, xmlResource, methodContext.getLoader());
    ...
    public SimpleMethod getSimpleMethodToCall(ClassLoader loader) throws MiniLangException {
        return getSimpleMethodToCall(methodName, xmlResource, loader);
    }

    public SimpleMethod getSimpleMethodToCall(String methodName, String xmlResource, ClassLoader loader) throws MiniLangException {
        SimpleMethod simpleMethodToCall = null;
