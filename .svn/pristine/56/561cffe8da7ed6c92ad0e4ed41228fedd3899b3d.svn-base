...
public class UtilFormatOut {
    ...
    public static String formatPercentage(Double percentage) {
        ...
        return formatPercentage(percentage, Locale.getDefault());
    }

    /** Formats a Double representing a percentage into a string
     * @param percentage The percentage Double to be formatted
     * @param locale The locale of the percentage value
     * @return A String with the formatted percentage
     */
    public static String formatPercentage(Double percentage, Locale locale) {
        if (percentage == null) return "";
        return formatPercentage(percentage.doubleValue(), locale);
    }
     ...
     * @return A String with the formatted percentage
     */
    public static String formatPercentage(BigDecimal percentage, Locale locale) {
        if (percentage == null) return "";
        return formatPercentage(percentage.doubleValue(), locale);
    }
    ...
    public static String formatPercentage(double percentage, Locale locale) {
        ...
        final DecimalFormat percentageDecimalFormat = new DecimalFormat("##0.##%", decimalFormatSymbols);
