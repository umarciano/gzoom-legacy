 SELECT 
  ...
  INNER JOIN <@table "ACCTG_TRANS_ENTRY"/> TE ON TE.GL_ACCOUNT_ID = IC.GL_ACCOUNT_ID_REF AND TE.AMOUNT IS NOT NULL
  ...
  GROUP BY AT.PARTY_ID, AT.ROLE_TYPE_ID, AC.GL_ACCOUNT_ID, WE.WORK_EFFORT_ID, WM.WORK_EFFORT_MEASURE_ID
