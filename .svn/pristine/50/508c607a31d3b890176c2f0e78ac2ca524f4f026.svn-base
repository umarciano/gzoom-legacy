...
<td>
       ...
       <#else>
		   ...
		   <input  class="autocompleter_parameter" type="hidden" name="constraintFields" value="[[<#if workEffortIdAll?default("N") == "N">[workEffortTypeId| equals| field:typeId]! </#if>[workEffortSnapshotId| <#if parameters.snapshot?if_exists?default("N") == 'Y'>not-equal<#else>equals</#if>| [null-field]]! [organizationId | equals| ${defaultOrganizationPartyId?if_exists}]]]"/>  
