...
<script type="text/javascript">
    var WorkEffortAchieveViewList_TwoColumns_Big_No_Txt = {
        cellOpenManagement : function(e) {
            ...
            if (Object.isElement(cellSelected)) {
                ...
                if (managementSelectedElementItem) {
                    ...
                    managementSelectedElementItem.populateElementCollection = WorkEffortAchieveViewList_TwoColumns_Big_No_Txt.selectedElementPopulateCollection.curry(cellSelected);
                    
                    checkExecutability = managementSelectedElementItem.checkExecutability;
                    managementSelectedElementItem.checkExecutability = WorkEffortAchieveViewList_TwoColumns_Big_No_Txt.checkExecutability.curry(cellSelected);
                }
        ...
        load : function() {
            var selectableTable = $('TwoColBigNoTxt_Table');
            
            selectableTable.select('td').each(function(cell) {
                Event.stopObserving(cell, 'dblclick');
                Event.observe(cell, 'dblclick', WorkEffortAchieveViewList_TwoColumns_Big_No_Txt.cellOpenManagement);
            });
    ...
    WorkEffortAchieveViewList_TwoColumns_Big_No_Txt.load();
</script>
...
<table cellspacing="15px" style="width: 100%" class="selectable dblclick-open-management" id="TwoColBigNoTxt_Table">
    <tbody>
        <#assign index = 0>
        <#list workEffortAchieveList as item>
            ...
            <#if (index % 2) == 0>
                ...
                <div id="value_${item.workEffortId}" class="mblContainer mblDisplayStringCell" style="color: red; font-weight: bold; font-size: 1.1em;">
