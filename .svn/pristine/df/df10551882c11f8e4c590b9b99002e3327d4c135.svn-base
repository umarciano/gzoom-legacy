...
public class LoopSubContentTransform implements TemplateTransformModel {
    ...
    public static final String[] saveKeyNames = {"contentId", "subContentId", "mimeType", "subContentDataResourceView", "wrapTemplateId", "entityList", "entityIndex", "contentTemplateId"};
    ...
    public static boolean prepCtx(Delegator delegator, Map ctx) {
        ...
        int i = idx.intValue();
        if (UtilValidate.isEmpty(lst) || (UtilValidate.isNotEmpty(lst) && i >= lst.size())) {
            return false;
        }
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        entityList = EntityUtil.orderBy(entityList, UtilMisc.toList(StringUtil.toList(orderBy)));
