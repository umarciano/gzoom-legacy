...
public class OrderByList implements Comparator<GenericEntity> {
    ...
    public String makeOrderByString(ModelEntity modelEntity, boolean includeTablenamePrefix, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) {
        StringBuilder sb = new StringBuilder();
        makeOrderByString(sb, modelEntity, includeTablenamePrefix, datasourceInfo, modelFieldTypeReader);
        return sb.toString();
    }

    public void makeOrderByString(StringBuilder sb, ModelEntity modelEntity, boolean includeTablenamePrefix, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) {
        ...
        for (int i = 0; i < orderByList.size(); i++) {
            ...
            orderByItem.makeOrderByString(sb, modelEntity, includeTablenamePrefix, datasourceInfo, modelFieldTypeReader);
        }
    }
    ...
    public String toString() {
        return makeOrderByString(null, false, null, null);
    }
}
