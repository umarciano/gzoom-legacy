		...
		<#include  "/workeffortext/webapp/workeffortext/birt/ftl/param/managementPrintBirtForm_exposeOnlyIndex.ftl" />	
		...
		<#include  "/workeffortext/webapp/workeffortext/birt/ftl/param/managementPrintBirtForm_excludePeg.ftl" />	
