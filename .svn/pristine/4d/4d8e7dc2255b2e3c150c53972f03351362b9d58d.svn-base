...
<doc:pi name="dbfo_keep-together" xmlns="">
  <refpurpose>Specifies â€œkeepâ€? behavior for a table, example,
  ...
  <refdescription>
    <para>Use the <tag class="xmlpi">dbfo keep-together</tag> PI as a child of a
      ...
      <tag>task</tag>) to specify â€œkeepâ€? behavior (to allow the object to 
    â€œbreakâ€? across a page).</para>
...
<doc:pi name="dbfo-need" xmlns="">
  ...
  <refdescription>
    <para>A â€œneedâ€? is a request for space on a page.  If the
