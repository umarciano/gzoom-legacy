...
public class ScreenRenderer {
    ...
    public String render(String resourceName, String screenName) throws GeneralException, IOException, SAXException, ParserConfigurationException {
        return this.render(resourceName, screenName, null);
    }

    public String render(String resourceName, String screenName, Map<String, Object> contextParams) throws GeneralException, IOException, SAXException, ParserConfigurationException {
        MapStack<String> localContext = context.standAloneChildStack();

        if (UtilValidate.isNotEmpty(contextParams)) {
            localContext.putAll(contextParams);
        }
        ...
        if (modelScreen.useCache) {
            ...
            WidgetContextCacheKey wcck = new WidgetContextCacheKey(localContext);
            ...
            if (gwo == null) {
                ...
                modelScreen.renderScreenString(sw, localContext, screenStringRenderer);
            ...
            modelScreen.renderScreenString(writer, localContext, screenStringRenderer);
        }
        return "";
    }
    ...
    public static void populateContextForRequest(MapStack<String> context, ScreenRenderer screens, HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) {
        ...
        // some information about language settings
        Map<String, Object> languageSettinngs = (Map<String, Object>) session.getAttribute("languageSettinngs");
        if (languageSettinngs != null) {
        	context.putAll(languageSettinngs);
        }
        
        Map<String, Object> userPreferences = (Map<String, Object>) context.get("userPreferences");
        context.put("defaultOrganizationPartyId", userPreferences.get("ORGANIZATION_PARTY"));
