...
elRTE.prototype.ui.prototype.buttons.image = function(rte, name) {
	...
	this.command = function() {
		...
		d.tab('main', this.rte.i18n('Properies'))
			...
			.append([this.rte.i18n('Size'), $('<span />').append(this.src.main.width).append(' px ').append(this.src.main.height).append(' px')], 'main', true)
...
//		this.origH = this.prevImg.attr('height');
	...
	this.updateDimesions = function(e) {
		...
		if ( w > 0) {
			this.src.main.width.val(w);
		} else {
			this.src.main.width.val(null);
		}
		
		var h = parseInt(this.src.main.height.val()) || 0;
		if ( h > 0) {
			this.src.main.height.val(h);
		} else {
			this.src.main.height.val(null);
		}
	...
	this.set = function() {
		...
		if (!this.prevImg) {
			...
			if ( w > 0) {
				this.img.attr("width", w);
			}
			
			var h = parseInt(this.src.main.height.val());			
			if ( h > 0) {
				this.img.attr("height", h);
			}	
