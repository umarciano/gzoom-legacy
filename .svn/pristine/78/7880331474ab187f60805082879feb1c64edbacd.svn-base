...
public class AccinpUoYearFiller extends AccinpUoFlagFiller {
	 ...
	 */
	AccinpUoYearFiller(Delegator delegator, Timestamp thruDate, String glFiscalTypeIdInput, List<String> factorFieldNames) {
    ...
    public List<Map<String, Object>> getExtraParametersList(String glAccountId, Map<String, ? extends Object> context) throws GenericEntityException {
        ...
        try {
            ...
            JdbcQueryIterator queryWorkEffortList = new FtlQuery(getDelegator(), workEffortCustmMethodYearCalculatorUtil.getQuery(InputAndDetailValue.ACCINP_UO_ANNO), queryContext).iterate();
