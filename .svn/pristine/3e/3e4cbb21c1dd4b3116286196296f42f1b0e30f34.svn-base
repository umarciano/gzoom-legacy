...
public abstract class ModelMenuAction {
    ...
    public static class Script extends ModelMenuAction {
        ...
        public void runAction(Map<String, Object> context) {
        	...
        	if (Debug.timingOn()) {
                ...
                Debug.logTiming("Run action script in " + totalSeconds + " milliseconds from. script = " + location, module);
            }
        }
    }
    ...
    public static class Service extends ModelMenuAction {
        ...
        public void runAction(Map<String, Object> context) {
        	...
        	if (Debug.timingOn()) {
                ...
                Debug.logTiming("Run action service in " + totalSeconds + " milliseconds. serviceName = " + serviceNameExpanded, module);
            }
        }
    }
    ...
    public static class EntityAnd extends ModelMenuAction {
        ...
        public void runAction(Map<String, Object> context) {
        	...
        	if (Debug.timingOn()) {
            	double totalSeconds = (System.currentTimeMillis() - startTime)/1000.0;
                Debug.logTiming("Run action entityAnd in " + totalSeconds + " milliseconds", module);
            }
        }
    }
    ...
    public static class EntityCondition extends ModelMenuAction {
        ...
        public void runAction(Map<String, Object> context) {
        	...
        	if (Debug.timingOn()) {
            	double totalSeconds = (System.currentTimeMillis() - startTime)/1000.0;
                Debug.logTiming("Run action entityCondition in " + totalSeconds + " milliseconds", module);
            }
        }
    }
}
