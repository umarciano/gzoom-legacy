<tr>
   <td class="label">${uiLabelMap.Technicalresponsibility}</td>
   <td class="widget-area-style"><div  class="droplist_field" id="${printBirtFormId?default("ManagementPrintBirtForm")}_personId">
   ...
   <input  class="autocompleter_parameter" type="hidden" name="constraintFields" value="[[[roleTypeId| equals| EMPLOYEE]]]"/>   
   <input  class="autocompleter_parameter" type="hidden" name="entityKeyField" value="partyId"/>
   <div class="droplist_container">
   <input type="text" size="100" maxlength="255" value="" class="droplist_edit_field"  name="personId_edit_value" id="${printBirtFormId?default("ManagementPrintBirtForm")}_personId_edit_value"  />   
   <input type="hidden" class="droplist_code_field" name="personId"/>
