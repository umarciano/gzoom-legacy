...
import com.mapsengineering.accountingext.util.WorkEffortCustmMethodTimeEntryCalculatorUtil;
...
public class AccinpWeTimeEntryFiller extends AccinpUoFlagFiller {
	 ...
	 */
	AccinpWeTimeEntryFiller(Delegator delegator, Timestamp thruDate, String glFiscalTypeIdInput, List<String> factorFieldNames) {
    ...
    public List<Map<String, Object>> getExtraParametersList(String glAccountId, Map<String, ? extends Object> context) throws GenericEntityException {
        ...
        WorkEffortCustmMethodTimeEntryCalculatorUtil workEffortCustmMethodTimeEntryCalculatorUtil = new WorkEffortCustmMethodTimeEntryCalculatorUtil(getDelegator(), context);        
        try {
        	Map<String, Object> queryContext = workEffortCustmMethodTimeEntryCalculatorUtil.mapContextUpdate(glAccountId, getThruDate(), getCustomMethodName(), context);
            JdbcQueryIterator queryWorkEffortList = new FtlQuery(getDelegator(), workEffortCustmMethodTimeEntryCalculatorUtil.getQuery(), queryContext).iterate();
