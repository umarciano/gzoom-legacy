 ...
 *
 */
public class TestIndicatorCalcServicesAggregLast extends TestIndicatorCalcServicesAggreg {
    
    /**
     * Test ACCINP_OBJ same workEffort Create movement for 2012,
     * WORK_EFFORT_ASSOC in 2012
     */
    public void testAcctgTransInterfaceAggreg() {
        updateCustomMethodAggreg();
