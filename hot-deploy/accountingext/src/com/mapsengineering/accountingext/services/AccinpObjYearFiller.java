...
public class AccinpObjYearFiller extends AccinpUoFlagFiller {
	 ...
	 */
	AccinpObjYearFiller(Delegator delegator, Timestamp thruDate, String glFiscalTypeIdInput, List<String> factorFieldNames) {
    ...
    public List<Map<String, Object>> getExtraParametersList(String glAccountId, Map<String, ? extends Object> context) throws GenericEntityException {
        ...
        try {
            ...
            JdbcQueryIterator queryWorkEffortList = new FtlQuery(getDelegator(), workEffortCustmMethodYearCalculatorUtil.getQuery(InputAndDetailValue.ACC_INP_OBJ_ANNO), queryContext).iterate();
