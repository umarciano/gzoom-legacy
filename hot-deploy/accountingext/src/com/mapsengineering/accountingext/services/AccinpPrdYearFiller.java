...
public class AccinpPrdYearFiller extends AccinpUoFlagFiller {
	 ...
	 */
	AccinpPrdYearFiller(Delegator delegator, Timestamp thruDate, String glFiscalTypeIdInput, List<String> factorFieldNames) {
    ...
    public List<Map<String, Object>> getExtraParametersList(String glAccountId, Map<String, ? extends Object> context) throws GenericEntityException {
        ...
        try {
            ...
            JdbcQueryIterator queryWorkEffortList = new FtlQuery(getDelegator(), workEffortCustmMethodYearCalculatorUtil.getQuery(InputAndDetailValue.ACC_INP_PRD_ANNO), queryContext).iterate();
            ...
            try {
                while (queryWorkEffortList.hasNext()) {
                    ...
                    String productId = ele.getString(WorkEffortFieldEnum.PRODUCT_ID.name());                   
                    ...
                    extraResultMap.put(E.productId.name(), productId);                                   
