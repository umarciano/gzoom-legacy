        ...
        try {
            ...
            try {
                while (queryWorkEffortList.hasNext()) {
                    ...
                    BigDecimal amount = getAmount(ele, (String) queryContext.get(WorkEffortFieldEnum.aggregType.name()));
                    ...
                    Double outputValue = getValue(amount, (String) queryContext.get(WorkEffortFieldEnum.aggregType.name()));
