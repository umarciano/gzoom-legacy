...
public class AccinpUoDetailYearFiller extends AccinpUoFlagFiller {
	 ...
	 */
	AccinpUoDetailYearFiller(Delegator delegator, Timestamp thruDate, String glFiscalTypeIdInput, List<String> factorFieldNames) {
    ...
    private EntityCondition getConditionWithDetail(Map<String, Object> extraCondition){
    ...
    public List<Map<String, Object>> getExtraParametersList(String glAccountId, Map<String, ? extends Object> context) throws GenericEntityException {
        ...
        try {
            ...
            JdbcQueryIterator queryWorkEffortList = new FtlQuery(getDelegator(), workEffortCustmMethodYearCalculatorUtil.getQuery(InputAndDetailValue.ACCINP_UO_DET_NOT_NULL_ANNO), queryContext).iterate();
