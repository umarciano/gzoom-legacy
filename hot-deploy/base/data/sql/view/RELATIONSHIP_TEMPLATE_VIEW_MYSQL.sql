DROP
	VIEW IF EXISTS RELATIONSHIP_TEMPLATE_VIEW;

DROP
	VIEW IF EXISTS RELATIONSHIP_FROM_THRU_DATE_VIEW;

DROP
	VIEW IF EXISTS RELATIONSHIP_FROM_DATE_VIEW_TOT;

DROP
	VIEW IF EXISTS RELATIONSHIP_THRU_DATE_VIEW_TOT;

DROP
	VIEW IF EXISTS RELATIONSHIP_THRU_DATE_VIEW;

DROP
	VIEW IF EXISTS RELATIONSHIP_FROM_DATE_VIEW;

DROP
	VIEW IF EXISTS RELATIONSHIP_ORG_VIEW;
