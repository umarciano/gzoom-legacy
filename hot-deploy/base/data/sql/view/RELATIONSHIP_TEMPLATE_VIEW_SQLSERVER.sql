IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_ORG_VIEW')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_ORG_VIEW
END;
...
IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_FROM_DATE_VIEW')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_FROM_DATE_VIEW
END;
...
IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_THRU_DATE_VIEW')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_THRU_DATE_VIEW
END;
...
IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_THRU_DATE_VIEW_TOT')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_THRU_DATE_VIEW_TOT
END;
...
IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_FROM_DATE_VIEW_TOT')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_FROM_DATE_VIEW_TOT
END;
...
IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_FROM_THRU_DATE_VIEW')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_FROM_THRU_DATE_VIEW
END;
...
IF EXISTS(
	...
	FROM
		SYS.OBJECTS
	WHERE
		OBJECT_ID = OBJECT_ID('dbo.RELATIONSHIP_TEMPLATE_VIEW')
		AND TYPE = 'V'
) BEGIN DROP
	VIEW RELATIONSHIP_TEMPLATE_VIEW
END;
