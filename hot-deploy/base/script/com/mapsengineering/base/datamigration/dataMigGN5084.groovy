 ...
 * <JobSandbox jobId="REMINDER_SCADENZA" jobName="Sollecito Scadenza" tempExprId="REMINDER" serviceName="reminderScadObiScheduled" runAsUser="admin" runTime="2000-01-01 00:00:00.000" poolId="pool" maxRecurrenceCount="-1"/>
*/
//CREO EVENDO HOUR_01
...
conditionReminder = EntityCondition.makeCondition(EntityCondition.makeCondition("jobName", "Sollecito Stampa Obiettivi Individuali (22)"),
    EntityCondition.makeCondition("statusId",  "SERVICE_PENDING")
);
...
if (UtilValidate.isEmpty(reminderScheduled) || reminderScheduled.size() <= 0) {
    ...
    jobSandBoxReminder.put("jobId", "REMINDER_ASSOBI_22");
    jobSandBoxReminder.put("jobName", "Sollecito Stampa Obiettivi Individuali (22)");
    jobSandBoxReminder.put("runTime", new Timestamp(UtilDateTime.toDate(1, 1, 2000, 0, 0, 0).getTime()));
    jobSandBoxReminder.put("serviceName", "reminderAssObi_22Scheduled");
...
//CREO EVENDO SOLLECITO OBIETTIVO
conditionReminder = EntityCondition.makeCondition(EntityCondition.makeCondition("jobName", "Sollecito Stampa Obiettivi Individuali Duplicato 1 (22)"),
  EntityCondition.makeCondition("statusId",  "SERVICE_PENDING")
);
def reminderScheduled = delegator.findList("JobSandbox", conditionReminder, null, null, null, false);
Debug.log("## reminderScheduled:"+reminderScheduled);
if (UtilValidate.isEmpty(reminderScheduled) || reminderScheduled.size() <= 0) {
  //inserisco
  jobSandBoxReminder = delegator.makeValue("JobSandbox");
  jobSandBoxReminder.put("jobId", "REMINDER_ASSOBI1_22");
  jobSandBoxReminder.put("jobName", "Sollecito Stampa Obiettivi Individuali Duplicato 1 (22)");
  jobSandBoxReminder.put("runTime", new Timestamp(UtilDateTime.toDate(1, 1, 2000, 0, 0, 0).getTime()));
  jobSandBoxReminder.put("serviceName", "reminderAssObi1_22Scheduled");
  jobSandBoxReminder.put("poolId", "pool");
  jobSandBoxReminder.put("runAsUser", "admin");
  jobSandBoxReminder.put("tempExprId", "REMINDER");
  jobSandBoxReminder.put("maxRecurrenceCount", -1L);
...
//CREO EVENDO SOLLECITO OBIETTIVO
conditionReminder = EntityCondition.makeCondition(EntityCondition.makeCondition("jobName", "Sollecito Stampa Obiettivi Individuali Duplicato 2 (22)"),
  EntityCondition.makeCondition("statusId",  "SERVICE_PENDING")
);
def reminderScheduled = delegator.findList("JobSandbox", conditionReminder, null, null, null, false);
Debug.log("## reminderScheduled:"+reminderScheduled);
if (UtilValidate.isEmpty(reminderScheduled) || reminderScheduled.size() <= 0) {
  //inserisco
  jobSandBoxReminder = delegator.makeValue("JobSandbox");
  jobSandBoxReminder.put("jobId", "REMINDER_ASSOBI2_22");
  jobSandBoxReminder.put("jobName", "Sollecito Stampa Obiettivi Individuali Duplicato 2 (22)");
  jobSandBoxReminder.put("runTime", new Timestamp(UtilDateTime.toDate(1, 1, 2000, 0, 0, 0).getTime()));
  jobSandBoxReminder.put("serviceName", "reminderAssObi2_22Scheduled");
  jobSandBoxReminder.put("poolId", "pool");
  jobSandBoxReminder.put("runAsUser", "admin");
  jobSandBoxReminder.put("tempExprId", "REMINDER");
  jobSandBoxReminder.put("maxRecurrenceCount", -1L);
...
//CREO EVENDO SOLLECITO OBIETTIVO
conditionReminder = EntityCondition.makeCondition(EntityCondition.makeCondition("jobName", "Sollecito Scheda Valutazioni Individuali (22)"),
  EntityCondition.makeCondition("statusId",  "SERVICE_PENDING")
);
def reminderScheduled = delegator.findList("JobSandbox", conditionReminder, null, null, null, false);
Debug.log("## reminderScheduled:"+reminderScheduled);
if (UtilValidate.isEmpty(reminderScheduled) || reminderScheduled.size() <= 0) {
  //inserisco
  jobSandBoxReminder = delegator.makeValue("JobSandbox");
  jobSandBoxReminder.put("jobId", "REMINDER_VALDIP_22");
  jobSandBoxReminder.put("jobName", "Sollecito Scheda Valutazioni Individuali (22)");
  jobSandBoxReminder.put("runTime", new Timestamp(UtilDateTime.toDate(1, 1, 2000, 0, 0, 0).getTime()));
  jobSandBoxReminder.put("serviceName", "reminderValDip_22Scheduled");
  jobSandBoxReminder.put("poolId", "pool");
  jobSandBoxReminder.put("runAsUser", "admin");
  jobSandBoxReminder.put("tempExprId", "REMINDER");
  jobSandBoxReminder.put("maxRecurrenceCount", -1L);
...
//CREO EVENDO SOLLECITO OBIETTIVO
conditionReminder = EntityCondition.makeCondition(EntityCondition.makeCondition("jobName", "Sollecito Scheda Valutazioni Individuali Duplicato 1 (22)"),
EntityCondition.makeCondition("statusId",  "SERVICE_PENDING")
);
def reminderScheduled = delegator.findList("JobSandbox", conditionReminder, null, null, null, false);
Debug.log("## reminderScheduled:"+reminderScheduled);
...
//inserisco
jobSandBoxReminder = delegator.makeValue("JobSandbox");
jobSandBoxReminder.put("jobId", "REMINDER_VALDIP1_22");
jobSandBoxReminder.put("jobName", "Sollecito Scheda Valutazioni Individuali Duplicato 1 (22)");
jobSandBoxReminder.put("runTime", new Timestamp(UtilDateTime.toDate(1, 1, 2000, 0, 0, 0).getTime()));
jobSandBoxReminder.put("serviceName", "reminderValDip1_22Scheduled");
jobSandBoxReminder.put("poolId", "pool");
jobSandBoxReminder.put("runAsUser", "admin");
jobSandBoxReminder.put("tempExprId", "REMINDER");
jobSandBoxReminder.put("maxRecurrenceCount", -1L);
...
//CREO EVENDO SOLLECITO OBIETTIVO
conditionReminder = EntityCondition.makeCondition(EntityCondition.makeCondition("jobName", "Sollecito Scheda Valutazioni Individuali Duplicato 2 (22)"),
EntityCondition.makeCondition("statusId",  "SERVICE_PENDING")
);
def reminderScheduled = delegator.findList("JobSandbox", conditionReminder, null, null, null, false);
Debug.log("## reminderScheduled:"+reminderScheduled);
...
//inserisco
jobSandBoxReminder = delegator.makeValue("JobSandbox");
jobSandBoxReminder.put("jobId", "REMINDER_VALDIP2_22");
jobSandBoxReminder.put("jobName", "Sollecito Scheda Valutazioni Individuali Duplicato 2 (22)");
jobSandBoxReminder.put("runTime", new Timestamp(UtilDateTime.toDate(1, 1, 2000, 0, 0, 0).getTime()));
jobSandBoxReminder.put("serviceName", "reminderValDip2_22Scheduled");
jobSandBoxReminder.put("poolId", "pool");
jobSandBoxReminder.put("runAsUser", "admin");
jobSandBoxReminder.put("tempExprId", "REMINDER");
jobSandBoxReminder.put("maxRecurrenceCount", -1L);
