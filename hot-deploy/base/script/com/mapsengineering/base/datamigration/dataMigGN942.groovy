...
Debug.log("Removing foreign keys and indices");
dbUtil.deleteForeignKeyAndIndex("WORK_EFFORT", "WE_SNAPSHOT_WE");
dbUtil.deleteForeignKeyAndIndex("ACCTG_TRANS", "ACCTTX_WE_SNAP");
dbUtil.deleteForeignKeyAndIndex("ACCTG_TRANS_ENTRY", "ACCTG_WE_SNAP");
