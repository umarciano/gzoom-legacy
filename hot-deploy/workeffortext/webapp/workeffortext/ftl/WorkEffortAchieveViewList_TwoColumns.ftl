...
<script type="text/javascript">
    var WorkEffortAchieveViewList_TwoColumns = {
        cellOpenManagement : function(e) {
            ...
            if (Object.isElement(cellSelected)) {
                ...
                if (managementSelectedElementItem) {
                    ...
                    managementSelectedElementItem.populateElementCollection = WorkEffortAchieveViewList_TwoColumns.selectedElementPopulateCollection.curry(cellSelected);
                    
                    checkExecutability = managementSelectedElementItem.checkExecutability;
                    managementSelectedElementItem.checkExecutability = WorkEffortAchieveViewList_TwoColumns.checkExecutability.curry(cellSelected);
                }
        ...
        load : function() {
            var selectableTable = $('TwoCol_Table');
            
            selectableTable.select('td').each(function(cell) {
                Event.stopObserving(cell, 'dblclick');
                Event.observe(cell, 'dblclick', WorkEffortAchieveViewList_TwoColumns.cellOpenManagement);
            });
    ...
    WorkEffortAchieveViewList_TwoColumns.load();
</script>
...
<table cellspacing="15px" style="width: 100%" class="selectable dblclick-open-management" id="TwoCol_Table">
    <tbody>
        <#assign index = 0>
