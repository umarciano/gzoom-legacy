...
<#else> 
    ...
    <div  class="droplist_field" id="WETVST003${accountTypeEnumId?if_exists}_WorkEffortTransactionView-${context.relationTitle?if_exists}_glAccountId">
        ...
        <input type="text" id="WETVST003${accountTypeEnumId?if_exists}_WorkEffortTransactionView-${context.relationTitle?if_exists}_glAccountId_edit_field" name="accountName_glAccountId" size="100" maxlength="255" value=""  class="droplist_edit_field"/>
