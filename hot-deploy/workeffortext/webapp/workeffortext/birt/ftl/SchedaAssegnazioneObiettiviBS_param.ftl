<#--
   Parametri di stampa CTX_BS - Scheda 1 (Assegnazione Obiettivi), report REPORT_BS_ASS.
   ...
   contentName = SchedaAssegnazioneObiettiviBS. Se manca, si torna al generico con tutti i parametri.
-->
<tr>
