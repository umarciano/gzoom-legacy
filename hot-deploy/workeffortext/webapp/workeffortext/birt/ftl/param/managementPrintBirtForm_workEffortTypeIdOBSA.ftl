<tr>
   <td class="label">${uiLabelMap.FormFieldTitle_workEffortTypeId}</td>
   <td class="widget-area-style">
       <div  class="droplist_field" id="${printBirtFormId?default("ManagementPrintBirtForm")}_typeId"> 
	       ...
	       <input  class="autocompleter_parameter" type="hidden" name="constraintFields" value="[[[workEffortTypeId| like| 18PMA3OBSA%]]]"/>
