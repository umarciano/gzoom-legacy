...
<td>
	   ...
	   <!-- controllo se ho i permessi -->
	    ...
	    <#else>
	    	<#assign mapService = Static["com.mapsengineering.base.birt.util.Utils"].getMapUserPermision(parameters.security, parameters.parentTypeId, parameters.userLogin, parameters.workEffortTypeId?if_exists, null )/> 
	  	</#if>
