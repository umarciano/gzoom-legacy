...
if (UtilValidate.isNotEmpty(multiTypeLang) && !"NONE".equals(multiTypeLang)) {
	...
	if ("Y".equals(context.hasResponse)) {
		context.commentsTitle = getFieldTitle(uiLabelMap.WorkEffortAssocExtView_hasResponseYesComments, primaryLangFlagPath, primaryLangTooltip);
	} else {
