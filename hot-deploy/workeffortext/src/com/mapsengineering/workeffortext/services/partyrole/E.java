...
public enum E {
    ...
    ROLE_TYPE_ID_TO, ROLE_TYPE_ID_FROM, FROM_DATE, THRU_DATE, PARTY_RELATIONSHIP_TYPE_ID, 
	
    parentRoleCode, partyName, partyNameLang, partyId, roleTypeId, userLoginId, statusId, organizationId, partyRelationshipTypeId,
    
    partyIdTo, partyIdFrom, fromDate, thruDate, roleTypeIdTo, roleTypeIdFrom, orgUnitId, onlyCurrentEvalRef, isOrgMgr
}
