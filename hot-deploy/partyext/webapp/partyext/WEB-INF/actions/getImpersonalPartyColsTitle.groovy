...
if (UtilValidate.isNotEmpty(multiTypeLang) && !"NONE".equals(multiTypeLang)) {
	...
	context.impGroupNameTitle = getFieldTitle(uiLabelMap.CommonDescription, primaryLangFlagPath, primaryLangTooltip);
	context.impGroupNameLangTitle = getFieldTitle("", secondaryLangFlagPath, secondaryLangTooltip);
}
