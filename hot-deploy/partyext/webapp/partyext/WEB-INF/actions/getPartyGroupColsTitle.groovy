...
if (UtilValidate.isNotEmpty(multiTypeLang) && !"NONE".equals(multiTypeLang)) {
	...
	context.pgrGroupNameTitle = getFieldTitle(uiLabelMap.PartyGroup_groupName, primaryLangFlagPath, primaryLangTooltip);
	context.pgrGroupNameLangTitle = getFieldTitle("", secondaryLangFlagPath, secondaryLangTooltip);
}
