#!/bin/bash
# Script bash per eseguire lo script Python di compilazione Schede
...
PYTHON_SCRIPT="$SCRIPT_DIR/script_compilazione_schede.py"

echo -e "${CYAN}=== Script Compilazione Schede ===${NC}"
