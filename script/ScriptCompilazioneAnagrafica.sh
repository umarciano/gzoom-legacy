#!/bin/bash
# Script bash per eseguire lo script Python di compilazione Anagrafica
...
PYTHON_SCRIPT="$SCRIPT_DIR/script_compilazione_anagrafica.py"

echo -e "${CYAN}=== Script Compilazione Anagrafica ===${NC}"
