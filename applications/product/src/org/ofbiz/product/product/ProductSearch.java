...
public class ProductSearch {
    ...
    public static class ProductSearchContext {
        ...
        public void finishCategoryAndFeatureConstraints() {
            ...
            Debug.logInfo("topCond=" + topCond.makeWhereString(null, FastList.<EntityConditionParam>newInstance(), EntityConfigUtil.getDatasourceInfo(delegator.getEntityHelperName("Product")), null), module);
        }
