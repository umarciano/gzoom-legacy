...
public class PartyServices {
    ...
    public static Map<String, Object> createPerson(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        if (party != null) {
            ...
            String fiscalCode = (String) context.get("fiscalCode");
            if (!UtilValidate.isEmpty(fiscalCode)) {
                newPartyMap.put("fiscalCode", fiscalCode);
            }
            if (userLogin != null) {
    ...
    public static Map<String, Object> createPartyGroup(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            if (party != null) {
                ...
                String vatCode = (String) context.get("vatCode");
                if (!UtilValidate.isEmpty(vatCode)) {
                    newPartyMap.put("vatCode", vatCode);
                }
