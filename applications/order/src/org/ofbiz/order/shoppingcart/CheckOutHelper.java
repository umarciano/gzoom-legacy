...
public class CheckOutHelper {
    ...
    public Map<String, Object> finalizeOrderEntryOptions(int shipGroupIndex, String shippingMethod, String shippingInstructions, String maySplit,
        ...
        if ((shipBeforeDate != null) && (shipBeforeDate.length() > 8)) {
           ...
           try {
               this.cart.setShipBeforeDate(shipGroupIndex, UtilDateTime.toTimestamp(shipBeforeDate, cart.getLocale()));
           } catch (Exception e) {
        ...
        if ((shipAfterDate != null) && (shipAfterDate.length() > 8)) {
           ...
           try {
               this.cart.setShipAfterDate(shipGroupIndex, UtilDateTime.toTimestamp(shipAfterDate, cart.getLocale()));
            } catch (Exception e) {
