...
public class BirtContainer implements Container {
    ...
    public boolean start() throws ContainerException {
        ...
        String birtRuntimeDir = UtilProperties.getPropertyValue("birt", "birt.runtime.dir");
        System.setProperty("birt.runtime.dir", birtRuntimeDir);

        config.setTempDir(birtRuntimeDir + "/tempfiles");
