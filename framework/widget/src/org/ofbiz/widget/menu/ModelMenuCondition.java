...
public class ModelMenuCondition {
    ...
    protected FlexibleStringExpander passAlignStyleExdr;
    protected FlexibleStringExpander failAlignStyleExdr;
    protected FlexibleStringExpander hideIfDisabledExdr;
    ...
    public ModelMenuCondition(ModelMenuItem modelMenuItem, Element conditionElement) {
        ...
        this.passAlignStyleExdr = FlexibleStringExpander.getInstance(conditionElement.getAttribute("pass-align-style"));
        this.failAlignStyleExdr = FlexibleStringExpander.getInstance(conditionElement.getAttribute("disabled-align-style"));
        this.hideIfDisabledExdr = FlexibleStringExpander.getInstance(UtilXml.checkEmpty(conditionElement.getAttribute("hide-if-disabled"), "true"));
    ...
    public ModelMenuCondition(ModelMenuItem parentMenuItem, ModelMenuCondition condition) {
        this.modelMenuItem = parentMenuItem;

        this.passStyleExdr = condition.passStyleExdr;
        this.failStyleExdr = condition.failStyleExdr;
        this.passAlignStyleExdr = condition.passAlignStyleExdr;
        this.failAlignStyleExdr = condition.failAlignStyleExdr;
        this.hideIfDisabledExdr = condition.hideIfDisabledExdr;
        this.rootCondition = condition.rootCondition;
    }
    ...
    public boolean eval(Map<String, Object> context) {
        ...
        if (cond) {
            ...
            String passAlignStyle = passAlignStyleExdr.expandString(context);
            if (UtilValidate.isNotEmpty(passAlignStyle)) {
                modelMenuItem.setAlignStyle(passAlignStyle);
            }
            modelMenuItem.setDisabled(false);
        } else {
            String failAlignStyle = failAlignStyleExdr.expandString(context);
            if (UtilValidate.isNotEmpty(failAlignStyle)) {
                modelMenuItem.setAlignStyle(failAlignStyle);
            }
            ...
            if (UtilValidate.isNotEmpty(failStyle) || UtilValidate.isNotEmpty(failAlignStyle)) {
                modelMenuItem.setDisabled(true);
                modelMenuItem.setHideIfDisabled(hideIfDisabledExdr.expandString(context));
                //cond = true;
            }
        }
        return cond;
    ...
    public void setModelMenuItem(ModelMenuItem modelMenuItem) {
        this.modelMenuItem = modelMenuItem;
        if (UtilValidate.isNotEmpty(this.rootCondition)) {
            this.rootCondition.setModelMenuItem(modelMenuItem);
        }
    }
    ...
    public static class And extends MenuCondition {
        ...
        public void setModelMenuItem(ModelMenuItem modelMenuItem) {
            super.setModelMenuItem(modelMenuItem);

            if (UtilValidate.isNotEmpty(this.subConditions)) {
                for(MenuCondition menuCondition : this.subConditions) {
                    menuCondition.setModelMenuItem(modelMenuItem);
                }
            }
        }
    }
    ...
    public static class Not extends MenuCondition {
        ...
        public void setModelMenuItem(ModelMenuItem modelMenuItem) {
            ...
            if (UtilValidate.isNotEmpty(this.subCondition)) {
                this.subCondition.setModelMenuItem(modelMenuItem);
            }
        }
    }
