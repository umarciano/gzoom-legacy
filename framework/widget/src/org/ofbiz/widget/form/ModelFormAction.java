...
import org.ofbiz.widget.screen.ModelScreenAction.Log;
...
public abstract class ModelFormAction {
    ...
    public static List<ModelFormAction> readSubActions(ModelForm modelForm, Element parentElement) {
        ...
        for (Element actionElement: UtilXml.childElementList(parentElement)) {
            if ("set".equals(actionElement.getNodeName())) {
            	...
            	actions.add(new Log(modelForm, actionElement));
            /* Maps end */	
            } else {
     ...
     */
    public static class Log extends ModelFormAction {
    	/**
    	 * Message string has to expand
    	 */
        protected FlexibleStringExpander message;
    	
    	public Log(ModelForm modelForm, Element logElement) {
			super(modelForm, logElement);
    ...
    public static class Script extends ModelFormAction {
        ...
        public void runAction(Map<String, Object> context) {
            ...
            if (Debug.timingOn()) {
                ...
                Debug.log("Run action script in " + (endTime - startTime) + " milliseconds. script = " + location, module);
            }
        }
    }
    ...
    public static class Service extends ModelFormAction {
        ...
        public void runAction(Map<String, Object> context) {
            ...
            if (Debug.timingOn()) {
                long endTime = System.currentTimeMillis(); 
                Debug.log("Run action service in " + (endTime - startTime) + " milliseconds. service = " + serviceNameExpanded, module);
            }
        }
    }
    ...
    public static class EntityAnd extends ModelFormAction {
        ...
        public void runAction(Map<String, Object> context) {
            ...
            if (Debug.timingOn()) {
                long endTime = System.currentTimeMillis(); 
                Debug.log("Run action entityAnd in " + (endTime - startTime) + " milliseconds", module);
            }
        }
