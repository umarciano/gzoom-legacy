...
public class ScreenFactory {
    ...
    public static Map<String, ModelScreen> getScreensFromLocation(String resourceName) 
        ...
        if (Debug.timingOn()) {
            Debug.logTiming("getScreensFromLocation " + resourceName, module);
        }
            ...
            synchronized (ScreenFactory.class) {
                ...
                if (modelScreenMap == null) {
                    ...
                    if (Debug.timingOn()) {
                        ...
                        Debug.logTiming("Got " + modelScreenMap.size() + " screens in " + totalSeconds + " milliseconds from: " + screenFileUrl.toExternalForm(), module);
                    }
                }
            }
        }
        if (Debug.timingOn()) {
            double totalSeconds = (System.currentTimeMillis() - startTime);
            Debug.logTiming("Got " + modelScreenMap.size() + " screens in " + totalSeconds + " milliseconds", module);
        }
    ...
    public static ModelScreen getScreenFromWebappContext(String resourceName, String screenName, HttpServletRequest request) 
        ...
        long startTime = System.currentTimeMillis();
        if (Debug.timingOn()) {
            Debug.logTiming("getScreenFromWebappContext " + cacheKey, module);
        }
        if (modelScreenMap == null) {
            synchronized (ScreenFactory.class) {
