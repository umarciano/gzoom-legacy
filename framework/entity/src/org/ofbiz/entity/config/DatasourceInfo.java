...
public class DatasourceInfo {
    ...
    public boolean useNotEqualsOrNullClause = true;
    ...
    public DatasourceInfo(Element element) {
        ...
        if (datasourceElement == null) {
            ...
            Debug.logWarning("datasource def not found with name " + this.name + ", using default for use-not-equals-or-null-clause (true)", module);
        } else {
            ...
            this.useNotEqualsOrNullClause = !"false".equals(datasourceElement.getAttribute("use-not-equals-or-null-clause"));
