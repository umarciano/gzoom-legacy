...
public class EntityFinderUtil {
    ...
    public static class ConditionExpr implements Condition {
        ...
        protected FlexibleStringExpander lookupForFieldNameExdr;
        ...
        public ConditionExpr(Element conditionExprElement) {
            ...
            this.lookupForFieldNameExdr = FlexibleStringExpander.getInstance(conditionExprElement.getAttribute("lookup-for-field-name"));
        ...
        public String getFieldName(Map<String, ? extends Object> context) {
            return this.fieldNameExdr.expandString(context);
        }
        public String getLookupForFieldName(Map<String, ? extends Object> context) {
            return this.lookupForFieldNameExdr.expandString(context);
        }
        public String getOperator(Map<String, ? extends Object> context) {
            return operatorExdr.expandString(context);
        }
        public Object getValue(Map<String, ? extends Object> context) {
            Object value = null;
        ...
        public EntityCondition createCondition(Map<String, ? extends Object> context, ModelEntity modelEntity, ModelFieldTypeReader modelFieldTypeReader) {
            ...
            if ((operator.equals(EntityOperator.IN) || operator.equals(EntityOperator.BETWEEN))
                ...
                if (UtilValidate.isNotEmpty(delim)) {
                	...
                	value = UtilMisc.toList((String)value);
                }
            }
