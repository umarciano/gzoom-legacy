...
public class EntityUtil {
    ...
    public static boolean isFilterByDateCompatible(ModelEntity modelEntity) {
        return EntityUtil.isFilterByDateCompatible(modelEntity, "thruDate");
    }

    public static boolean isFilterByDateCompatible(ModelEntity modelEntity, String thruDateName) {
        ModelField mField = modelEntity.getField(thruDateName);
        return UtilValidate.isEmpty(mField) ? false : true ;
    }
