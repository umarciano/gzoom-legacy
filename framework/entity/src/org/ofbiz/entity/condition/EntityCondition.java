...
public abstract class EntityCondition extends EntityConditionBase implements Reusable {
    ...
    public String toString() {
        return makeWhereString(null, FastList.<EntityConditionParam>newInstance(), null, null);
    }
    ...
    abstract public String makeWhereString(ModelEntity modelEntity, List<EntityConditionParam> entityConditionParams, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader);
