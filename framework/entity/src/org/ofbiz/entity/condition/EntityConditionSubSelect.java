...
public class EntityConditionSubSelect extends EntityConditionValue {
    ...
    public void addSqlValue(StringBuilder sql, Map<String, String> tableAliases, ModelEntity parentModelEntity, List<EntityConditionParam> entityConditionParams,
            boolean includeTableNamePrefix, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) {
        ...
        try {
            ...
            sql.append(SqlJdbcUtil.makeFromClause(localModelEntity, datasourceInfo, modelFieldTypeReader));

            // WHERE clause
            StringBuilder whereString = new StringBuilder();
            String entityCondWhereString = "";
            if (this.whereCond != null) {
                entityCondWhereString = this.whereCond.makeWhereString(localModelEntity, entityConditionParams, datasourceInfo, modelFieldTypeReader);
            }

            String viewClause = SqlJdbcUtil.makeViewWhereClause(localModelEntity, datasourceInfo, modelFieldTypeReader);
