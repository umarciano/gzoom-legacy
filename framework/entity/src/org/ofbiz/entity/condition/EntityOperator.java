...
public abstract class EntityOperator<L, R, T> extends EntityConditionBase {
    ...
    public static final int ID_EQUALS_FIELD = 15;
    public static final int ID_NOT_EQUAL_FIELD = 16;
    public static final int ID_LESS_THAN_FIELD = 17;
    public static final int ID_GREATER_THAN_FIELD = 18;
    public static final int ID_LESS_THAN_EQUAL_TO_FIELD = 19;
    public static final int ID_GREATER_THAN_EQUAL_TO_FIELD = 20;
    ...
    public static final EntityComparisonOperator<?,?> EQUALS = new ComparableEntityComparisonOperator<Object>(ID_EQUALS, "=") {
        ...
        @Override
        protected void makeRHSWhereString(ModelEntity entity, List<EntityConditionParam> entityConditionParams, StringBuilder sb, ModelField field, Object rhs, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) {
            if (rhs == null || rhs == GenericEntity.NULL_FIELD) {
                ...
                super.makeRHSWhereString(entity, entityConditionParams, sb, field, rhs, datasourceInfo, modelFieldTypeReader);
            }
        }
    };
    ...
    public static final EntityComparisonOperator<?,?> IN = new CollectionEntityComparisonOperator<Object>(ID_IN, "IN") {
        ...
        @Override
        protected void makeRHSWhereStringValue(ModelEntity entity, List<EntityConditionParam> entityConditionParams, StringBuilder sb, ModelField field, Collection<Comparable<Object>> rhs, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) { appendRHSList(entityConditionParams, sb, field, rhs); }
    };
    ...
    public static final EntityComparisonOperator<?,?> BETWEEN = new CollectionEntityComparisonOperator<Object>(ID_BETWEEN, "BETWEEN") {
        ...
        public boolean compare(Comparable<Object> lhs, Collection<Comparable<Object>> rhs) { return EntityComparisonOperator.compareIn(lhs, rhs); }
        @Override
        protected void makeRHSWhereStringValue(ModelEntity entity, List<EntityConditionParam> entityConditionParams, StringBuilder sb, ModelField field, Collection<Comparable<Object>> rhs, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) { appendRHSBetweenList(entityConditionParams, sb, field, rhs); }
    };
    ...
    public static final EntityComparisonOperator<?,?> NOT = new EntityComparisonOperator<Object, EntityCondition>(ID_NOT, "NOT") {
        ...
        @Override
        public Object getRHS(Object rhs) {
    ...
    public static final EntityComparisonOperator<?,?> EQUALS_FIELD = new ComparableEntityComparisonOperator<Object>(ID_EQUALS_FIELD, "=") {
    	@Override
    	public Object getRHS(Object rhs) { 
        	if (rhs instanceof String) {
        		rhs = EntityFieldValue.makeFieldValue((String) rhs);
        	} 
        	return rhs;
        };
    	@Override
    ...
    static { register( "equals-field", EQUALS_FIELD ); }
    public static final EntityComparisonOperator<?,?> NOT_EQUAL_FIELD = new ComparableEntityComparisonOperator<Object>(ID_NOT_EQUAL_FIELD, "<>") {
    	@Override
    	public Object getRHS(Object rhs) { 
        	if (rhs instanceof String) {
        		rhs = EntityFieldValue.makeFieldValue((String) rhs);
    ...
    static { register( "not-equal-field", NOT_EQUAL_FIELD ); }
    static { register( "not-equals-field", NOT_EQUAL_FIELD ); }
    static { register( "notEqualField", NOT_EQUAL_FIELD ); }
    public static final EntityComparisonOperator<?,?> LESS_THAN_FIELD = new ComparableEntityComparisonOperator<Object>(ID_LESS_THAN_FIELD, "<") {
    	@Override
    	public Object getRHS(Object rhs) { 
        	if (rhs instanceof String) {
        		rhs = EntityFieldValue.makeFieldValue((String) rhs);
    ...
    static { register( "less-field", LESS_THAN_FIELD ); }
    static { register( "less-than-field", LESS_THAN_FIELD ); }
    static { register( "lessThanField", LESS_THAN_FIELD ); }
    public static final EntityComparisonOperator<?,?> GREATER_THAN_FIELD = new ComparableEntityComparisonOperator<Object>(ID_GREATER_THAN_FIELD, ">") {
    	@Override
    	public Object getRHS(Object rhs) { 
        	if (rhs instanceof String) {
        		rhs = EntityFieldValue.makeFieldValue((String) rhs);
    ...
    static { register( "greater-field", GREATER_THAN_FIELD ); }
    static { register( "greater-than-field", GREATER_THAN_FIELD ); }
    static { register( "greaterThanField", GREATER_THAN_FIELD ); }
    public static final EntityComparisonOperator<?,?> LESS_THAN_EQUAL_TO_FIELD = new ComparableEntityComparisonOperator<Object>(ID_LESS_THAN_EQUAL_TO_FIELD, "<=") {
    	@Override
    	public Object getRHS(Object rhs) { 
        	if (rhs instanceof String) {
        		rhs = EntityFieldValue.makeFieldValue((String) rhs);
    ...
    static { register( "less-equals-field", LESS_THAN_EQUAL_TO_FIELD ); }
    static { register( "less-than-equal-to-field", LESS_THAN_EQUAL_TO_FIELD ); }
    static { register( "lessThanEqualToField", LESS_THAN_EQUAL_TO_FIELD ); }
    public static final EntityComparisonOperator<?,?> GREATER_THAN_EQUAL_TO_FIELD = new ComparableEntityComparisonOperator<Object>(ID_GREATER_THAN_EQUAL_TO_FIELD, ">=") {
        @Override
    	public Object getRHS(Object rhs) { 
        	if (rhs instanceof String) {
        		rhs = EntityFieldValue.makeFieldValue((String) rhs);
    ...
    static { register( "greater-equals-field", GREATER_THAN_EQUAL_TO_FIELD ); }
    static { register( "greater-than-equal-to-field", GREATER_THAN_EQUAL_TO_FIELD ); }
    static { register( "greaterThanEqualToField", GREATER_THAN_EQUAL_TO_FIELD ); }
    ...
    */
    ...
    public void addSqlValue(StringBuilder sql, ModelEntity entity, List<EntityConditionParam> entityConditionParams, L lhs, R rhs, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader) {
        addSqlValue(sql, entity, entityConditionParams, true, lhs, rhs, datasourceInfo, modelFieldTypeReader);
    }

    public abstract void addSqlValue(StringBuilder sql, ModelEntity entity, List<EntityConditionParam> entityConditionParams, boolean compat, L lhs, R rhs, DatasourceInfo datasourceInfo, ModelFieldTypeReader modelFieldTypeReader);
