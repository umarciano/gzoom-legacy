...
public class UtilDateTime {
     ...
     * JDBC escape format for java.sql.Timestamp conversions.
     */
    public static final String TIMESTAMP_FORMAT = "EEEE MMMM d, yyyy";

    public static String getFormattedDateTime(String dateStr, String pattern, TimeZone timeZone, Locale locale) {
        try {
    ...
    public static String getFormattedDate(String dateStr, String pattern, TimeZone timeZone, Locale locale) {
        try {
            DateFormat df = UtilDateTime.toDateTimeFormat(UtilDateTime.DATE_FORMAT,timeZone, locale);
            Date d = df.parse(dateStr);
            ...
            try {
                DateFormat df = UtilDateTime.toDateTimeFormat(UtilDateTime.getDateFormat(locale),timeZone, locale);
                Date d = df.parse(dateStr);
    ...
    public static String getFormattedTime(String dateStr, String pattern, TimeZone timeZone, Locale locale) {
        try {
            DateFormat df = UtilDateTime.toDateTimeFormat(UtilDateTime.TIME_FORMAT,timeZone, locale);
            Date d = df.parse(dateStr);
            ...
            try {
                DateFormat df = UtilDateTime.toDateTimeFormat(UtilDateTime.getTimeFormat(locale),timeZone, locale);
                Date d = df.parse(dateStr);
    ...
    public static String getDateFormat(Locale locale) {
        String res = UtilProperties.getMessage("CommonUiLabels", "DateFormat", locale);
    ...
    public static String getTimeFormat(Locale locale) {
        String res = UtilProperties.getMessage("CommonUiLabels", "TimeFormat", locale);
        if (UtilValidate.isEmpty(res))
            return TIME_FORMAT;
        return res;
    }
    ...
    public static String getDateTimeFormat(Locale locale) {
        String res = UtilProperties.getMessage("CommonUiLabels", "DateTimeFormat", locale);
        if (UtilValidate.isEmpty(res))
            return DATE_TIME_FORMAT;
        return res;
    }

    public static String getTimestampFormat(Locale locale) {
        String res = UtilProperties.getMessage("CommonUiLabels", "TimestampFormat", locale);
        if (UtilValidate.isEmpty(res))
    ...
    public static int getIntervalInDays(Timestamp from, Timestamp thru) {
        return thru != null ? (int) ((thru.getTime() - from.getTime()) / (24L*60L*60L*1000L)) : 0;
    }
    ...
    public static java.sql.Timestamp getYearEnd(java.sql.Timestamp stamp) {
        return getYearEnd(stamp, TimeZone.getDefault(), Locale.getDefault());
    }
     ...
     * Converts a date String into a java.sql.Date
     *
     * @param date The date String in the locale format or ISO Format
     * @param locale Locale information
     * @return A java.sql.Date made from the date String
     */
    public static java.sql.Date toSqlDate(String date, Locale locale) {
        return toSqlDate(date, null, null, locale);
    }
     ...
     * @return A java.sql.Date made from the date String
     */
    public static java.sql.Date toSqlDate(String date, TimeZone tz,  Locale locale) {
        return toSqlDate(date, null, tz, locale);
    }
     ...
     *
     * @param date The date String in the locale format or ISO Format
     * @param format The format of the date String or null
     * @param tz TimeZone information
     * @param locale Locale information
     * @return A java.sql.Date made from the date String
     */
    public static java.sql.Date toSqlDate(String date, String format, TimeZone tz,  Locale locale) {
        java.util.Date newDate = toDate(date, format, tz, locale);
     ...
     *
     * @param dateTime A combined data and time string in the locale format, the seconds are optional
     * @return The corresponding Timestamp
     */
    public static java.sql.Timestamp toTimestamp(String dateTime, Locale locale) {
        java.util.Date newDate = toDate(dateTime, locale);
     ...
     */
    public static java.util.Date toDate(String date, Locale locale) {
        return toDate(date, null, null, locale);
    }

    /**
     * Converts a date String and a time String into a Date
     */
    public static java.util.Date toDate(String date, TimeZone tz, Locale locale) {
        return toDate(date, null, tz, locale);
    }
    
    /**
     * Converts a date String and a time String into a Date with lenient false
     */
    public static java.util.Date toDate(String date, String format, TimeZone tz, Locale locale) {
        return toDate(date, format, tz, locale, false);
    }

    /**
     * Converts a date String and a time String into a Date
     */
    public static java.util.Date toDate(String date, String format, TimeZone tz, Locale locale, boolean lenient) {
        ...
        try {
            if (UtilValidate.isNotEmpty(date)) {
                ...
                if (UtilValidate.isEmpty(format))
                    format = UtilDateTime.getDateTimeFormat(locale);
                DateFormat df = UtilDateTime.toDateTimeFormat(format, tz, locale);
    ...
    /**
     * Makes a date String in the format of the current locale from a Date
     *
     * @param date The Date
     * @param locale the current locale
     * @return @return A date String in the format of the current locale
     */
    public static String toDateString(java.util.Date date, Locale locale) {
        try {
            return toDateString(date, getDateFormat(locale));
        } catch (Exception e) {
    ...
    /**
     * Makes a date String in the sql format from a Date
     *
     * @param date The Date
     * @return A date String in the sql format
     */
    public static String toSqlDateString(java.util.Date date) {
        return toDateString(date, DATE_TIME_FORMAT);
    }
    ...
    public static Date toJavaDate(java.sql.Timestamp date) {
        if (date == null) return null;
